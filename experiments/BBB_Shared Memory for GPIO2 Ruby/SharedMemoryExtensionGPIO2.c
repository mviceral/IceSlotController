...
VALUE SharedMemoryExtensionGpio2 = Qnil;


// Prototype for the initialization method - Ruby calls this, not you
void Init_SharedMemoryExtensionGpio2();
...
void Init_SharedMemoryExtensionGpio2() {
	SharedMemoryExtensionGpio2 = rb_define_module("SharedMemoryExtensionGpio2");
	rb_define_method(SharedMemoryExtensionGpio2, "WriteDataToSharedMemory", method_WriteDataToSharedMemory, 1);
	rb_define_method(SharedMemoryExtensionGpio2, "GetDataFromSharedMemory", method_GetDataFromSharedMemory, 0);
	rb_define_method(SharedMemoryExtensionGpio2, "InitializeSharedMemory", method_InitializeSharedMemory, 0);
}
