...
VALUE SharedMemoryBbbGpio2Extension = Qnil;


// Prototype for the initialization method - Ruby calls this, not you
void Init_SharedMemoryBbbGpio2Extension();
...
void Init_SharedMemoryBbbGpio2Extension() {
	SharedMemoryBbbGpio2Extension = rb_define_module("SharedMemoryBbbGpio2Extension");
	rb_define_method(SharedMemoryBbbGpio2Extension, "WriteDataToSharedMemory", method_WriteDataToSharedMemory, 1);
	rb_define_method(SharedMemoryBbbGpio2Extension, "GetDataFromSharedMemory", method_GetDataFromSharedMemory, 0);
	rb_define_method(SharedMemoryBbbGpio2Extension, "InitializeSharedMemory", method_InitializeSharedMemory, 0);
}
