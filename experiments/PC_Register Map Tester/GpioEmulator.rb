...
def uiTest
	...
	<center>
		<table>
			...
			ui += testItemByte("0x00 SLOTADDR","SLOT1|SLOT0|SYS5|SYS4|SYS3|SYS2|SYS1|SYS0")
			ui += testItemBit("0x02 EXT_INPUTS","FANT2B|FANT2A|FANT1B|FANT1A|SENSR2|SENSR1|USRSW2|USRSW1")
			ui += testItemBit("0x06 ETS_ALM1","ALM7|ALM6|ALM5|ALM4|ALM3|ALM2|ALM1|ALM0")
			ui += testItemBit("0x07 ETS_ALM2","ALM15|ALM14|ALM13|ALM12|ALM11|ALM10|ALM9|ALM8")
			ui += testItemBit("0x08 ETS_ALM2","ALM23|ALM22|ALM21|ALM20|ALM19|ALM18|ALM17|ALM16")
			ui += 
		"</table></td><td>&nbsp;</td></tr>			
			<tr><td>&nbsp;</td></tr>
		</table>
