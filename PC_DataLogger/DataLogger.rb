	...
	def logData(slotOwnerParam)
		...
		if @sharedMem.getMemory()[SharedLib::PC][slotOwnerParam].nil? == false
			...
			if SharedLib::InRunMode == @sharedMem.GetDispBbbMode(slotOwnerParam) && @lastLog[slotOwnerParam] <= Time.new.to_i
				...
				setDataForLogging("PS0I",@sharedMem.getPsCurrent(muxData,eiPs,nil,nil))
				setDataForLogging("PS1V",@sharedMem.getPsVolts(muxData,adcData,"33"))
				setDataForLogging("PS1I",@sharedMem.getPsCurrent(muxData,eiPs,nil,nil))
				setDataForLogging("PS2V",@sharedMem.getPsVolts(muxData,adcData,"34"))
				setDataForLogging("PS2I",@sharedMem.getPsCurrent(muxData,eiPs,nil,nil))
				...
				setDataForLogging("PS4I",@sharedMem.getPsCurrent(muxData,eiPs,nil,nil))
				setDataForLogging("PS5V",@sharedMem.getPsVolts(muxData,adcData,"37"))
				setDataForLogging("PS5I",@sharedMem.getPsCurrent(muxData,eiPs,nil,nil))
				...
				setDataForLogging("PS7I",@sharedMem.getPsCurrent(muxData,eiPs,nil,nil))
