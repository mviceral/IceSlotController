...
=end
	...
	def GetDataToSendPc(sharedMemParam)
        ...
        if sharedMemParam.GetConfiguration().nil? == false
            ...
            slotInfo[SharedMemory::LotDesc] = sharedMemParam.GetConfiguration()[SharedMemory::LotDesc]
        end
...
=end                                
                        ...
                        begin
                            ...
                            begin
                                ...
                                sentBackLogData = "#{Time.now.inspect} - Sent backlog data. #{__LINE__}-#{__FILE__}"
                                `echo \"#{sentBackLogData}\" >> /mnt/card/Activity.log`
